<div class="form-group {{ $errors->has('name') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="name" type="text" id="name"
           value="{{ isset($breeder->name) ? $breeder->name : ''}}">
    {!! $errors->first('name', '<p class="help-block">:message</p>') !!}
</div>
<div class="form-group {{ $errors->has('address') ? 'has-error' : ''}}">
    <label for="address" class="control-label">{{ 'Alamat' }}</label>
    <input class="form-control" name="address" type="text" id="address"
           value="{{ isset($breeder->address) ? $breeder->address : ''}}">
...
<div class="form-group {{ $errors->has('company_name') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="company_name" type="text" id="company_name"
           value="{{ isset($breeder->company_name) ? $breeder->company_name : ''}}">
...
<div class="form-group {{ $errors->has('company_address') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="company_address" type="text" id="company_address"
           value="{{ isset($breeder->company_address) ? $breeder->company_address : ''}}">
...
<div class="form-group {{ $errors->has('phone_number') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="phone_number" type="text" id="phone_number"
           value="{{ isset($breeder->phone_number) ? $breeder->phone_number : ''}}">
...
<div class="form-group {{ $errors->has('actor_status') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="actor_status" type="text" id="actor_status"
           value="{{ isset($breeder->actor_status) ? $breeder->actor_status : ''}}">
...
<div class="form-group {{ $errors->has('short_description') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="short_description" type="text" id="short_description"
           value="{{ isset($breeder->short_description) ? $breeder->short_description : ''}}">
...
<div class="form-group {{ $errors->has('email') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="email" type="text" id="email"
           value="{{ isset($breeder->email) ? $breeder->email : ''}}">
    {!! $errors->first('email', '<p class="help-block">:message</p>') !!}
</div>
<div class="form-group {{ $errors->has('username') ? 'has-error' : ''}}">
    <label for="username" class="control-label">{{ 'Username' }}</label>
    <input class="form-control" name="username" type="text" id="username"
           value="{{ isset($breeder->username) ? $breeder->username : ''}}">
...
<div class="form-group">
    ...
    <a class="btn btn-warning btn-sm" href="{{ route('breeders.index') }}" title="Kembali"><i class="fa fa-arrow-left"
                                                                                              aria-hidden="true"></i>
        Kembali
    </a>
